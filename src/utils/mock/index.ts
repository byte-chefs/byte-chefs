export const mockRecipe =
  {
    ...
    cookingTime: 20,
    description: "A healthy grilled chicken salad with fresh greens, cherry tomatoes, and balsamic dressing.",
    calories: 400,
    favouritesTotal: 8,
    difficulty: "easy",
    status: "published",
    ...
    tags: [
      { "recipeId": 2, "tagId": 2, "tag": { "id": 2, "name": "Healthy", "include": ["salad"], "exclude": ["fried"] } }
    ],
    userFavorites: [
      { "userId": 3, "recipeId": 2 }
    ],
